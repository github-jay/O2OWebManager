 ...
 */
@Entity
@Table(name = "orderi", catalog = "o2owebsit", uniqueConstraints = @UniqueConstraint(columnNames = "OrderNum"))
public class Order implements java.io.Serializable {
	...
	/** minimal constructor */
	public Order(String orderNum, Integer userId, Date startTime,
			String orderName, String address, boolean isPaied, boolean chekOut) {
	...
	/** full constructor */
	public Order(String orderNum, Integer userId, Date startTime,
			Date finishTime, String orderName, String address, boolean isPaied,
			boolean chekOut) {
		this.orderNum = orderNum;
		this.userId = userId;
		this.startTime = startTime;
